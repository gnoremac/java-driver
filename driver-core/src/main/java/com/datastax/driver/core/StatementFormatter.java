...
public final class StatementFormatter {
    ...
    public static final class StatementWriterSymbols {
        ...
        private StatementWriterSymbols(
                // summary
                String summaryStart, String boundValuesCount, String statementsCount, String summaryEnd,
                // query string
    ...
    /**
     * A statement writer exposes facility methods to help
    ...
    public static class Builder {
        ...
        public StatementFormatter build() {
            ...
            StatementWriterSymbols symbols = new StatementWriterSymbols(
                    summaryStart, boundValuesCount, statementsCount, summaryEnd,
